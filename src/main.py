...
Original file is located at
    https://colab.research.google.com/drive/1pb5am66SNPpG2ipzCfe9ZXKgSCxnjxKD
"""
...
for index, order in orders_df.iterrows():
    assigned_robot = status.choice(range(num_robots))  # Assign order to a robot based on robot status
